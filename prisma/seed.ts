...
async function main() {
  ...
  const store = await prisma.store.upsert({
    ...
    create: {
      ...
      description: 'متجر متخصص في بيع الأجهزة الإلكت��ونية والهواتف الذكية بأفضل الأسعار',
      category: 'إلكترونيات',
      status: 'ACTIVE',
      settings: {
        create: {
  ...
  const pages = await Promise.all([
    prisma.contentPage.upsert({
      ...
      create: {
        title: 'من نحن',
        slug: 'about-us',
        content: '<h1>مرحباً بكم في بيت السوداني</h1><p>منصة التجارة الإلكترونية الرائدة في السودان</p>',
        excerpt: 'تعرف على قصتنا ورؤيتنا',
        status: 'PUBLISHED',
        type: 'PAGE',
        language: 'AR',
        metaTitle: 'من نحن - بيت السوداني',
        metaDescription: 'تعرف على بيت السوداني، منصة التجارة الإلكترونية الرائدة في السودان',
    ...
    prisma.contentPage.upsert({
      ...
      create: {
        ...
        slug: 'privacy-policy',
        content: '<h1>سياسة الخصوصية</h1><p>نحن نحترم خصوصيتك ونحمي بياناتك الشخصية</p>',

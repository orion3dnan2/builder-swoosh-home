...
const translations = {
  ar: {
    ...
    'home.services.marketplace_desc': 'اكتشف منتجات سودانية أصيلة من تجار موثوقين',
    'home.services.companies': 'دليل الشركات',
    'home.services.companies_desc': 'تواصل مع الشركات والمؤسسات السودانية في الخليج',
    ...
    'home.services.professional_desc': 'احصل على خدمات مهنية متخصصة من خبراء سودانيين',
  ...
  en: {
    ...
    'home.hero.subtitle': 'Sudan market, services and companies in the Gulf and worldwide',
    'home.hero.explore_market': 'Explore Market',
    'home.hero.join_us': 'Join Us',
    'home.services.title': 'Our Services',
    'home.services.subtitle': 'Comprehensive services designed specifically for the Sudanese community in the Gulf and worldwide',
    'home.services.marketplace': 'Commercial Market',
    'home.services.marketplace_desc': 'Discover authentic Sudanese products from trusted merchants',
    'home.services.companies': 'Company Directory',
    'home.services.companies_desc': 'Connect with Sudanese companies and institutions in the Gulf',
    'home.services.jobs': 'Job Board',
    'home.services.jobs_desc': 'Find suitable job opportunities or post job vacancies',
    'home.services.professional': 'Professional Services',
    'home.services.professional_desc': 'Get specialized professional services from Sudanese experts',
    'home.services.ads': 'Advertisements',
    'home.services.ads_desc': 'Promote your business and services to the Sudanese community',
    'home.services.discover': 'Discover More',
    'home.testimonials.title': 'Customer Reviews',
    'home.testimonials.subtitle': 'What our customers say about their experience with us',
    'home.cta.title': 'Start Your Journey With Us Today',
    'home.cta.subtitle': 'Join thousands of Sudanese who use Sudan House to grow their businesses and services',
    ...
    'stores.store_details_desc': 'Comprehensive information about the store and its activity',
    ...
    'stores.confirm_reactivate': 'Are you sure you want to reactivate this store?',

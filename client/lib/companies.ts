...
export class CompaniesService {
  private static demoCompanies: Company[] = [
    {
      ...
      description: "شركة رائدة في مجال تطوير البرمجيات والحلول التقنية المتقدمة. نخدم العملاء في منطقة الخليج والشرق الأوسط بأحدث التقنيات والمعايير العالمية.",
    ...
    },
    {
      ...
      description: "مجموعة استثمارية متنوعة تعمل في قطاعات العقارات، التجارة، وا��خدمات المالية. تأسست لتكون جسراً بين السودان ودول الخليج.",
      logo: "/placeholder.svg",
      coverImage: "/placeholder.svg",
    ...
    },
    {
      ...
      description: "شركة متخصصة في المقاولات العامة وأعمال البناء والتشييد. خبرة واسعة في تنفيذ المشاريع السكنية والتجارية والصناعية.",
      logo: "/placeholder.svg",
      coverImage: "/placeholder.svg",
    ...
    },
    {
      ...
      description: "سلسلة مطاعم متخصصة في تقديم الأطباق السودانية التقليدية بأعلى معايير الجودة والنظافة. نقدم تجربة طعام أصيلة للمغتربين السودانيين.",
      logo: "/placeholder.svg",
      coverImage: "/placeholder.svg",
    ...
    },
    {
      ...
      description: "مجموعة عيادات طبية متخصصة تقدم خدمات طبية شاملة بأحدث التقنيات الطبية وكادر طبي متخصص من ذوي الخبرة العالية.",
      logo: "/placeholder.svg",
      coverImage: "/placeholder.svg",
    ...
    },
    {
      ...
      description: "شركة متخصصة في استيراد وتصدير المنتجات الزراعية والغذائية بين السودان ودول الخليج. نربط المنتجين بالمستهلكين بأعلى معايير الجودة.",
      logo: "/placeholder.svg",
      coverImage: "/placeholder.svg",
    ...
    },
    {
      ...
      description: "مؤسسة تعليمية رائدة تقدم برامج تدريبية وتعليمية متخصصة للمهنيين السودانيين. نركز على تطوير المهارات والقدرات المهنية.",
      logo: "/placeholder.svg",
      coverImage: "/placeholder.svg",
    ...
    },
    {
      ...
      description: "شركة متخصصة في خدمات النقل والشحن واللوجستيات بين دول الخليج والسودان. نوفر حلول شحن متكاملة وموثوقة.",
      logo: "/placeholder.svg",
      coverImage: "/placeholder.svg",
  ...
  static getFeaturedCompanies(): Company[] {
    return this.demoCompanies.filter(company => company.isFeatured && company.status === "active");
  }

  static getVerifiedCompanies(): Company[] {
    return this.demoCompanies.filter(company => company.isVerified && company.status === "active");
  }

  static getCompaniesByIndustry(industry: string): Company[] {
    return this.demoCompanies.filter(company => 
      company.industry === industry && company.status === "active"
    );
  }

  static getCompaniesByCategory(category: string): Company[] {
    return this.demoCompanies.filter(company => 
      company.category === category && company.status === "active"
    );
  }
  ...
  static getCompaniesBySize(size: string): Company[] {
    return this.demoCompanies.filter(company => 
      company.size === size && company.status === "active"
    );
  }
  ...
  static searchCompanies(query: string): Company[] {
    ...
    return this.demoCompanies.filter(company =>
      company.status === "active" && (
        ...
        company.specializations.some(spec => spec.toLowerCase().includes(searchTerm))
      )
    );
  }
  ...
  static getIndustries(): string[] {
    const industries = [...new Set(this.demoCompanies.map(company => company.industry))];
    return industries.sort();
  }

  static getCountries(): string[] {
    const countries = [...new Set(this.demoCompanies.map(company => company.location.country))];

...
export default function AdminSettings() {
  const { user } = useAuth();
  const { settings, updateTheme, updateBranding, updateFeatures, saveSettings, resetToDefaults, colorPalettes, fontFamilies } = useAppSettings();
  ...
  const applyColorPalette = (palette: { primary: string; secondary: string }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4 space-x-reverse">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 arabic">إعدادات التطبيق</h1>
                <p className="text-gray-600 arabic">تخصيص المظهر والإعدادات العامة</p>
              </div>
            </div>
            <div className="flex items-center space-x-4 space-x-reverse">
              {unsavedChanges && (
                <Badge variant="secondary" className="arabic">تغييرات غير محفوظة</Badge>
              )}
              <Button variant="outline" onClick={handleReset} className="arabic">
                <RotateCcw className="w-4 h-4 ml-2" />
                إعادة تعيين
              </Button>
              <Button onClick={handleSave} disabled={!unsavedChanges} className="arabic">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="theme" className="space-y-6">
          <TabsList className="grid w-full grid-cols-5">
            <TabsTrigger value="theme" className="arabic">المظهر</TabsTrigger>
            <TabsTrigger value="branding" className="arabic">العلامة التجارية</TabsTrigger>
            <TabsTrigger value="features" className="arabic">الميزات</TabsTrigger>
            <TabsTrigger value="content" className="arabic">المحتوى</TabsTrigger>
            <TabsTrigger value="advanced" className="arabic">متقدم</TabsTrigger>
          </TabsList>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2 space-x-reverse mt-2">
                          <div 
                            className="w-8 h-8 rounded-lg border-2 border-gray-300"
                            style={{ backgroundColor: localSettings.theme.secondaryColor }}
                          ></div>
                          <Input
                            type="color"
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 border rounded-lg bg-gray-50">
                      <h4 className="text-xl font-bold mb-2 arabic" style={{ fontFamily: fontFamilies[localSettings.theme.fontFamily as keyof typeof fontFamilies] }}>
                        البيت السوداني
                      </h4>
                      <p className="text-gray-600 arabic" style={{ fontFamily: fontFamilies[localSettings.theme.fontFamily as keyof typeof fontFamilies] }}>
                    ...
                    <div className="border rounded-lg p-4 bg-white">
                      ...
                      <div className="space-y-2">
                        ...
                        <div 
                          ...
                          style={{ backgroundColor: localSettings.theme.secondaryColor, opacity: 0.3 }}
                        ></div>
                      </div>
                    </div>
                  </div>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleBrandingChange('heroBackground', e.target.value)}
                      className="mt-2"
                      rows={3}
                    ...
                    <div key={key} className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 arabic">
                          {key === 'enableMarketplace' && 'تفعيل قسم السوق التجاري'}
                          {key === 'enableProducts' && 'تفعيل قسم بيع المنتجات'}
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleBrandingChange('termsOfService', e.target.value)}
                      className="mt-2 arabic text-right"
                      rows={4}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleBrandingChange('privacyPolicy', e.target.value)}
                      className="mt-2 arabic text-right"
                      rows={4}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleBrandingChange('refundPolicy', e.target.value)}
                      className="mt-2 arabic text-right"
                      rows={4}
              ...
              <CardContent className="space-y-6">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-yellow-800 arabic">
                    ⚠️ تحذير: الإعدادات المتقدمة قد تؤثر على أداء التطبيق. يُنصح بعدم تغييرها إلا إذا كنت تعرف ما تفعل.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select 
                      ...
                      onChange={(e) => setLocalSettings({
                        ...localSettings,
                        localization: { ...localSettings.localization, defaultLanguage: e.target.value as 'ar' | 'en' }
                      })}
                      className="w-full mt-2 p-2 border rounded-lg arabic"
                    >
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      <Label className="font-medium arabic">دعم الكتابة من اليمين لليسار</Label>
                      <p className="text-sm text-gray-600 arabic">تفعيل RTL للغة العربية</p>
                    </div>
                    <Switch
                      checked={localSettings.localization.rtlSupport}
                      onCheckedChange={(checked) => setLocalSettings({
                        ...localSettings,
                        localization: { ...localSettings.localization, rtlSupport: checked }
                      })}
                    />
                  </div>
                </div>

        ...
        <div className="mb-8">
          <div className="flex items-center justify-center space-x-8 space-x-reverse">
            <div className="flex items-center">
              ...
              <span className="mr-2 text-sm arabic text-green-600 font-medium">
                السلة
              </span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="mr-2 text-sm arabic text-blue-600 font-medium">
                الدفع
              </span>
            </div>
            ...
            <Card className="bg-blue-50 border-blue-200">
              <CardContent className="p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-800 arabic">
                      دفع آمن ومضمون
                    </h4>
                    <p className="text-sm text-blue-700 arabic mt-1">
                      جميع المعاملات محمية بتشفير SSL 256-bit ومراقبة من قبل

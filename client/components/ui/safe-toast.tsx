...
if (typeof window !== "undefined") {
  try {
    ...
    OriginalToastViewport = React.forwardRef<any, any>(
      ({ className, ...props }, ref) =>
    ...
    OriginalToast = React.forwardRef<any, any>(
    ...
    OriginalToastAction = React.forwardRef<any, any>(
      ({ className, ...props }, ref) =>
    ...
    OriginalToastClose = React.forwardRef<any, any>(
      ({ className, ...props }, ref) =>
    ...
    OriginalToastTitle = React.forwardRef<any, any>(
      ({ className, ...props }, ref) =>
    ...
    OriginalToastDescription = React.forwardRef<any, any>(
      ({ className, ...props }, ref) =>
    ...
    console.warn(
      "Failed to load Radix UI Toast components, using fallbacks:",
      error,
    );
  }
}
...
// Fallback components
const FallbackToastProvider: React.FC<SafeToastProviderProps> = ({
  children,
}) => {
  return (
...
const FallbackToastViewport: React.FC<SafeToastViewportProps> = ({
  className,
}) => {
  return (
    <div
...
const FallbackToast: React.FC<SafeToastProps> = ({
  children,
  className,
  variant = "default",
}) => {
...
const FallbackToastAction: React.FC<SafeToastActionProps> = ({
  children,
  className,
  onClick,
}) => {
...
const FallbackToastClose: React.FC<SafeToastCloseProps> = ({
  className,
  onClick,
}) => {
  return (
...
const FallbackToastTitle: React.FC<SafeToastTitleProps> = ({
  children,
  className,
}) => {
  return (
...
const FallbackToastDescription: React.FC<SafeToastDescriptionProps> = ({
  children,
  className,
}) => {
  return (
    <div className={cn("text-sm opacity-90", className)} data-fallback="true">
      {children}
    </div>
  );
};
...
export const SafeToastProvider: React.FC<SafeToastProviderProps> = ({
  children,
}) => {
  try {
...
export const SafeToastViewport = React.forwardRef<
  HTMLDivElement,
  SafeToastViewportProps
>(({ className, ...props }, ref) => {
  try {
    if (OriginalToastViewport && typeof window !== "undefined") {
      return React.createElement(OriginalToastViewport, {
        ref,
        className,
        ...props,
      });
...
export const SafeToast = React.forwardRef<HTMLDivElement, SafeToastProps>(
  ({ children, className, variant, ...props }, ref) => {
    ...
    return (
      <FallbackToast className={className} variant={variant}>
        {children}
      </FallbackToast>
    );
  },
...
export const SafeToastAction = React.forwardRef<
  HTMLButtonElement,
  SafeToastActionProps
>(({ children, className, onClick, ...props }, ref) => {
  try {
    if (OriginalToastAction && typeof window !== "undefined") {
      return React.createElement(
        OriginalToastAction,
        { ref, className, onClick, ...props },
        children,
      );
    }
  } catch (error) {
  ...
  return (
    <FallbackToastAction className={className} onClick={onClick}>
      {children}
    </FallbackToastAction>
  );
});
...
export const SafeToastClose = React.forwardRef<
  HTMLButtonElement,
  SafeToastCloseProps
>(({ className, onClick, ...props }, ref) => {
  try {
    if (OriginalToastClose && typeof window !== "undefined") {
      return React.createElement(OriginalToastClose, {
        ref,
        className,
        onClick,
        ...props,
...
export const SafeToastTitle = React.forwardRef<
  HTMLDivElement,
  SafeToastTitleProps
>(({ children, className, ...props }, ref) => {
  ...
  return (
    <FallbackToastTitle className={className}>{children}</FallbackToastTitle>
  );
});
SafeToastTitle.displayName = "SafeToastTitle";

export const SafeToastDescription = React.forwardRef<
  HTMLDivElement,
  SafeToastDescriptionProps
>(({ children, className, ...props }, ref) => {
  try {
    if (OriginalToastDescription && typeof window !== "undefined") {
      return React.createElement(
        OriginalToastDescription,
        { ref, className, ...props },
        children,
      );
    }
    ...
    console.warn(
      "SafeToastDescription: Radix UI failed, using fallback:",
      error,
    );
  }
  return (
    <FallbackToastDescription className={className}>
      {children}
    </FallbackToastDescription>
  );
});
